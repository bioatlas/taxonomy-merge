...
# Save to tsvs
write.table(df, file = "~/data/lucene/sources/gtdb-full.tsv", sep='\t', row.names = F, na = '', quote = FALSE)
write.table(filt.df, file = "~/data/lucene/sources/gtdb-filt.tsv", sep='\t', row.names = F, na = '', quote = FALSE)
